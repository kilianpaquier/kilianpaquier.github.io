...
export default {
    ...
    old_experiences_title: "Other experiences",
    experiences: [
        {
            subtitles: [
                "Software Engineer",
        ...
        },
        {
            ...
            missions: [
                "Leading and contribution to a blockchains' state of the art, use of a blockchain",
        ...
        {
            subtitles: [
                "Java & Swing technical study temporary worker",
                "August 2018"
            ],
            captions: [
        ...
        {
            subtitles: [
                "Youth work qualification trainer",
                "February, April, August 2017"
            ],
            captions: [
    ...
    educations: [
        ...
        },
        {
            ...
            diploma: "Computer engineering degree"
        }
    ],
