    ...
    <v-row :no-gutters="true">
        ...
        <v-col cols="12">
            <v-timeline side="end" density="comfortable">
                <v-timeline-item v-for="(education, e_index) in educations" :key="'education_' + e_index" :fill-dot="true" size="large" width="100%">
                    <template #icon>
                    ...
                    <v-card :title="education.title">
                        ...
                        <v-card-text :class="{ 'pb-0': !education.skills || education.caption }" class="pt-3">
                            <v-row v-if="education.skills" :no-gutters="true">
                                <v-col v-for="(skill, s_index) in education.skills" :key="'experience_skill' + s_index" :class="{ 'me-2': s_index < education.skills.length - 1 }" class="my-1" cols="auto">
